...
/**
 * Navigation: A class based on the FTC sample ConceptVuforiaSkyStoneNavigation
 */
public class Navigation {
    ...
    private VuforiaLocalizer nav = null;
    ...
    public Navigation (OpMode opmode) {
        ...
        targetsSkyStone = nav.loadTrackablesFromAsset("Skystone");
    ...
    public void activate ()     { targetsSkyStone.activate(); }
    // Disable Tracking when we are done;
    public void deactivate ()   { targetsSkyStone.deactivate(); }
}
